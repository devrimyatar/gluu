...
class Body1(object):
    ...
    def redis_provider_type(self):
        """Gets the redis_provider_type of this Body1.  # noqa: E501

        Type of connection.  # noqa: E501

        :return: The redis_provider_type of this Body1.  # noqa: E501
        :rtype: str
        """
    ...
    def redis_provider_type(self, redis_provider_type):
        """Sets the redis_provider_type of this Body1.

        Type of connection.  # noqa: E501

        :param redis_provider_type: The redis_provider_type of this Body1.  # noqa: E501
        :type: str
        """
    ...
    @property
    def servers(self):
        """Gets the servers of this Body1.  # noqa: E501

        server details separated by comma e.g. 'server1:8080server2:8081'.  # noqa: E501

        :return: The servers of this Body1.  # noqa: E501
        :rtype: str
        """
    ...
    def servers(self, servers):
        """Sets the servers of this Body1.

        server details separated by comma e.g. 'server1:8080server2:8081'.  # noqa: E501

        :param servers: The servers of this Body1.  # noqa: E501
        :type: str
        """
    ...
    def default_put_expiration(self):
        """Gets the default_put_expiration of this Body1.  # noqa: E501

        defaultPutExpiration timeout value.  # noqa: E501

        :return: The default_put_expiration of this Body1.  # noqa: E501
        :rtype: int
        """
    ...
    def default_put_expiration(self, default_put_expiration):
        """Sets the default_put_expiration of this Body1.

        defaultPutExpiration timeout value.  # noqa: E501

        :param default_put_expiration: The default_put_expiration of this Body1.  # noqa: E501
        :type: int
        """
    ...
    def sentinel_master_group_name(self):
        """Gets the sentinel_master_group_name of this Body1.  # noqa: E501

        Sentinel Master Group Name (required if SENTINEL type of connection is selected).  # noqa: E501

        :return: The sentinel_master_group_name of this Body1.  # noqa: E501
        :rtype: str
        """
    ...
    def sentinel_master_group_name(self, sentinel_master_group_name):
        """Sets the sentinel_master_group_name of this Body1.

        Sentinel Master Group Name (required if SENTINEL type of connection is selected).  # noqa: E501

        :param sentinel_master_group_name: The sentinel_master_group_name of this Body1.  # noqa: E501
        :type: str
        """
    ...
    @property
    def use_ssl(self):
        """Gets the use_ssl of this Body1.  # noqa: E501

        Enable SSL communication between Gluu Server and Redis cache.  # noqa: E501

        :return: The use_ssl of this Body1.  # noqa: E501
        :rtype: bool
        """
    ...
    def use_ssl(self, use_ssl):
        """Sets the use_ssl of this Body1.

        Enable SSL communication between Gluu Server and Redis cache.  # noqa: E501

        :param use_ssl: The use_ssl of this Body1.  # noqa: E501
        :type: bool
        """
    ...
    def ssl_trust_store_file_path(self):
        """Gets the ssl_trust_store_file_path of this Body1.  # noqa: E501

        Directory Path to Trust Store.  # noqa: E501

        :return: The ssl_trust_store_file_path of this Body1.  # noqa: E501
        :rtype: str
        """
    ...
    def ssl_trust_store_file_path(self, ssl_trust_store_file_path):
        """Sets the ssl_trust_store_file_path of this Body1.

        Directory Path to Trust Store.  # noqa: E501

        :param ssl_trust_store_file_path: The ssl_trust_store_file_path of this Body1.  # noqa: E501
        :type: str
        """
    ...
    def max_idle_connections(self):
        """Gets the max_idle_connections of this Body1.  # noqa: E501
        ...
        :return: The max_idle_connections of this Body1.  # noqa: E501
        :rtype: int
        """
    ...
    def max_idle_connections(self, max_idle_connections):
        """Sets the max_idle_connections of this Body1.

        The cap on the number of \\idle\\ instances in the pool. If max idle is set too low on heavily loaded systems it is possible you will see objects being destroyed and almost immediately new objects being created. This is a result of the active threads momentarily returning objects faster than they are requesting them causing the number of idle objects to rise above max idle. The best value for max idle for heavily loaded system will vary but the default is a good starting point.  # noqa: E501

        :param max_idle_connections: The max_idle_connections of this Body1.  # noqa: E501
        :type: int
        """
    ...
    def max_total_connections(self):
        """Gets the max_total_connections of this Body1.  # noqa: E501

        The number of maximum connection instances in the pool.  # noqa: E501

        :return: The max_total_connections of this Body1.  # noqa: E501
        :rtype: int
        """
    ...
    def max_total_connections(self, max_total_connections):
        """Sets the max_total_connections of this Body1.

        The number of maximum connection instances in the pool.  # noqa: E501

        :param max_total_connections: The max_total_connections of this Body1.  # noqa: E501
        :type: int
        """
    ...
    def connection_timeout(self):
        """Gets the connection_timeout of this Body1.  # noqa: E501

        Connection time out.  # noqa: E501

        :return: The connection_timeout of this Body1.  # noqa: E501
        :rtype: int
        """
    ...
    def connection_timeout(self, connection_timeout):
        """Sets the connection_timeout of this Body1.

        Connection time out.  # noqa: E501

        :param connection_timeout: The connection_timeout of this Body1.  # noqa: E501
        :type: int
        """
    ...
    @property
    def so_timeout(self):
        """Gets the so_timeout of this Body1.  # noqa: E501
        ...
        :return: The so_timeout of this Body1.  # noqa: E501
        :rtype: int
        """
    ...
    def so_timeout(self, so_timeout):
        """Sets the so_timeout of this Body1.

        With this option set to a non-zero timeout a read() call on the InputStream associated with this Socket will block for only this amount of time. If the timeout expires a java.net.SocketTimeoutException is raised though the Socket is still valid. The option must be enabled prior to entering the blocking operation to have effect. The timeout must be > 0. A timeout of zero is interpreted as an infinite timeout.  # noqa: E501

        :param so_timeout: The so_timeout of this Body1.  # noqa: E501
        :type: int
        """
    ...
    def max_retry_attempts(self):
        """Gets the max_retry_attempts of this Body1.  # noqa: E501

        Maximum retry attempts in case of failure.  # noqa: E501

        :return: The max_retry_attempts of this Body1.  # noqa: E501
        :rtype: int
        """
    ...
    def max_retry_attempts(self, max_retry_attempts):
        """Sets the max_retry_attempts of this Body1.

        Maximum retry attempts in case of failure.  # noqa: E501

        :param max_retry_attempts: The max_retry_attempts of this Body1.  # noqa: E501
        :type: int
        """
